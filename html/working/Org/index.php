...
session_start();
  ...
  $username = '';
  if(!isset($_SESSION['loggedin']) || $_SESSION['loggedin']==false || !isset($_SESSION['isOrg']) || $_SESSION['isOrg']==false){
    session_destroy();
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          ...
          <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#portfolio">Browse</a>
        </div>
      </div>
    </header>
      ...
      <!--<div class="container">
        ...
        <div class="row">
          <div class="col-md-4 col-sm-6 portfolio-item">
            <a class="portfolio-link" href="../Events/view_offline.php">
              <div class="portfolio-hover">
                <div class="portfolio-hover-content">
                  <i class="fa fa-plus fa-3x"></i>
                </div>
              </div>
              <img class="img-fluid" src="img/portfolio/list.jpg" alt="">
            </a>
            <div class="portfolio-caption">
              <h4>View my Events</h4>
              <p class="text-muted">List of all the events created by you.</p>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 portfolio-item">
            <a class="portfolio-link" href="../offline_event.php">
              <div class="portfolio-hover">
                <div class="portfolio-hover-content">
                  <i class="fa fa-plus fa-3x"></i>
                </div>
              </div>
              <img class="img-fluid" src="img/portfolio/offline.jpg" alt="">
            </a>
            <div class="portfolio-caption">
              <h4>Create Offline Event</h4>
              <p class="text-muted">Events to spread joy by physical presence of like minded people.</p>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 portfolio-item">
            <a class="portfolio-link" href="../online_event.php">
              <div class="portfolio-hover">
                <div class="portfolio-hover-content">
                  <i class="fa fa-plus fa-3x"></i>
                </div>
              </div>
              <img class="img-fluid" src="img/portfolio/online.jpg" alt="">
            </a>
            <div class="portfolio-caption">
              <h4>Create Online Event</h4>
              <p class="text-muted">Money can't buy everything but it surely can spread some joy.</p>
            </div>
          </div>
          <!--<div class="col-md-4 col-sm-6 portfolio-item">
