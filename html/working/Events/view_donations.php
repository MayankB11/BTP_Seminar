...
session_start();
  ...
  $user = $_SESSION['id'];
  $result = mysqli_query($conn,"SELECT * FROM  User_online WHERE user_id = '$user'");
  ?>
<!DOCTYPE html>
<html lang="en" >
...
<link href="http://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css" rel="stylesheet">  
 <link href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" rel="stylesheet"/>
  ...
  <div class="container">
  <div class="page-header"><h2> My Donations </h2></div>
  ...
  function familyName($result) {
    ...
    while($res=mysqli_fetch_array($result)){
      echo "<tr>
              <td>".$i."
              <td>".$res['event_id']."
              <td>".$res['amount_donated']."
              <td>".$res['time_of_donation']."
          </tr>";
      $i = $i+1;
    }
  }
