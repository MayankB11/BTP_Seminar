      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="../Events/view_donations.php">View Transactions</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../Events/registrations.php">View Registered Events</a>
            </li>
            <li class="nav-item">
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          ...
          <div class="intro-lead-in">Account Balance: <?php echo $money?></div>
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <p class="item-intro text-muted">"Every patient carries his or her own doctor inside" --Albert Schweitzer</p>
                  <img class="img-fluid d-block mx-auto" src="img/portfolio/01-full.jpg" alt="">
                  <p>Health Care is not a privilege. It's a right. It's a right as fundamental as civil rights. It's a right as fundamental as giving every child a chance to get a public education.</p>
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <p class="item-intro text-muted">"Babies have much higher levels of stress in childcare." --Mem Fox</p>
                  <img class="img-fluid d-block mx-auto" src="img/portfolio/02-full.jpg" alt="">
                  <p>Every time a woman leaves the workforce because she can't find or afford childcare, or she can't work out a flexible arrangement with her boss, or she has no paid maternity leave, her family's income falls down a notch. Simultaneously, national productivity numbers decline.</p>
                  <button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fa fa-times"></i>
                    Close Project</button>
                </div>
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <p class="item-intro text-muted">"The army teaches boys to think like men." --Elvis Presley</p>
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <p class="item-intro text-muted">"We have two options, medically and emotionally: give up or fight like hell." --Lance Armstrong</p>
                  <img class="img-fluid d-block mx-auto" src="img/portfolio/04-full.jpg" alt="">
                  <p>Some kids wish to be a cowboy.....to be a princess.....to be a chef while others wish for a cure so they can grow up</p>
                  <button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fa fa-times"></i>
                    Close Project</button>
                </div>
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <p class="item-intro text-muted">"To save a life, is to save all of humanity" --White Helmets</p>
                  <img class="img-fluid d-block mx-auto" src="img/portfolio/05-full.jpg" alt="">
                  <p>"What is at stake is nothing less than the survival and well-being of a generation of innocents" --Antonio Guterres</p>
                  <button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fa fa-times"></i>
                    Close Project</button>
                </div>
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <p class="item-intro text-muted">"While natural disasters capture headlines and national attention short-term, the work of recovery and rebuilding is long-term." --Sylvia Mathews Burwell</p>
