...
<body>
  ...
  <div class="log-form" style="overflow:scroll; height:600px; width: 500px; padding:0em;">
  <h2 style="border-radius: 0px 0px 0px 0px">Create an Offline Event</h2>
  ...
  <form method="post" action="offline_event.php">
    ...
    ?>
    <p>Start Time</p>
    <input type="time" name="start_time" title="start_time" placeholder="Start Time" />
    
    <?php if($user_error[10] != ''){
      echo '<div class="alert alert-danger"><strong>Warning!</strong> '.$user_error[10].'</div>';
    } 
    ?>
    <input type="number" name="max_users" title="max_users" placeholder="Target Users" />
    ...
    <a class="forgot" href="Org/index.php">Back to Profile Page.</a>
  </form>
</div><!--end log form -->
